...
require(pacman)
pacman::p_load(raster, sf, ggplot2, dplyr, cowplot, ggnewscale, ggrepel)
...
ena_adm <- readRDS(paste0(idir, 'Data/fig2/ena_adm.rds'))
...
sa_adm <- readRDS(paste0(idir, 'Data/fig2/sa_adm.rds'))
...
china_adm <- readRDS(paste0(idir, 'Data/fig2/china_adm.rds'))
